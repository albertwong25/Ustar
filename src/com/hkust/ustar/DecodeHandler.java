...
import com.hkust.ustar.BeepManager;
import com.hkust.ustar.CaptureActivity;
...
final class DecodeHandler extends Handler {
  ...
  @SuppressWarnings("unused")
    ...
    try {     
      ...
      // Always get the word bounding boxes--we want it for annotating the bitmap after the user presses the shutter button
